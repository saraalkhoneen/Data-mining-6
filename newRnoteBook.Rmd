...
# Perform cross-validation with C4.5
for (i in 1:num_folds) {
  # Extract the indices for the current fold
  test_indices <- unlist(folds[[i]])
  ...
  # Train the C4.5 model with information gain
  tree_model <- C5.0(myFormula, data = training_set, control = C5.0Control(allowSurrogates = FALSE))
