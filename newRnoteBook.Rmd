...
The p-value we got as a result of this test was 0.01583 which is less than 0.05. Based on the result we got, we learned that weather someone is a foregin worker or not could lead to a higher or lower credit risk.
...
The p-value we got as a result of this test was 0.2789 which is more than 0.05. Which implies that weather a person own a telephone or not does not necessarily correlate with having a higher or lower credit risk.
